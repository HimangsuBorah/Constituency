...
const corsOptions = {
  origin: ['http://localhost:3000','http://localhost:5173','https://bhaskarsharma.yourmla.com','https://admin.yourmla.com','https://heroic-sfogliatella-ed8512.netlify.app'], // Allow requests from your Netlify frontend domain
